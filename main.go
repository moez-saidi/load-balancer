...
func (lb *LoadBalancer) getNextAvailableServer(servers []*Server) *Server {
	lb.Mutex.Lock()
...
func main() {
	...
	http.HandleFunc("/", func(w http.ResponseWriter, r *http.Request) {
		server := lb.getNextAvailableServer(servers)
		if server == nil {
	...
	if err != nil {
		log.Fatalf("Error starting load balancer: %s", err.Error())
	}
}
